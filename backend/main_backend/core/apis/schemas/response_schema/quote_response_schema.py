"""Response schemas for quote-related APIs in the main backend."""
...
class QuoteSelectedAddOnResponse(BaseModel):
    """Represents one selected add-on returned in a quote response.
...
class QuoteAvailableAddOnResponse(BaseModel):
    """Represents one available add-on returned in a quote response.
...
class QuoteItemResponse(BaseModel):
    """Represents one quote item returned to the main-backend client.
